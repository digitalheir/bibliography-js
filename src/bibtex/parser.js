...
export default {
  ParserRules: [
    ...
    {"name": "value_string$subexpression$1$ebnf$1$subexpression$1", "symbols": [pound, "quoted_string_or_ref"]},
    ...
    {"name": "braced_string", "symbols": [brace_l, brace_r], "postprocess": function (data, location, reject) { return joinTokens(data[1]); }},
    ...
    {"name": "braced_text", "symbols": [brace_l, "braced_text_content", brace_r], "postprocess": function (data, location, reject) { return joinTokens(data[1]); }},
    {"name": "braced_text_content", "symbols": [brace_l, "braced_text_content", brace_l]},
    {"name": "braced_text_content$ebnf$1", "symbols": []},
    {"name": "braced_text_content$ebnf$1", "symbols": ["non_bracket", "braced_text_content$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "braced_text_content", "symbols": ["braced_text_content$ebnf$1"], "postprocess":  function (data, location, reject) {
    ...
    {"name": "refkey$subexpression$1", "symbols": [brace_l]},
    {"name": "refkey$subexpression$1", "symbols": [brace_r, entry_type_bib]},
    ...
    {"name": "non_quote_dbl$subexpression$1", "symbols": [quote_dbl]},
